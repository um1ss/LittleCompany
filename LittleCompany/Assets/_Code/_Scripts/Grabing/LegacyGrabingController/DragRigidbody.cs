...
public class DragRigidbody : MonoBehaviour
{
    ...
    public void HandleInputBegin(Vector3 screenPosition)
    {
        ...
        {
            if (hit.transform.gameObject.layer == LayerMask.NameToLayer("Grabing"))
            {
                dragDepth = CameraPlane.Instance.CameraToPointDepth(Camera.main, hit.point);
    ...
    public void HandleInput(Vector3 screenPosition)
    {
        ...
        jointTrans.position = CameraPlane.Instance.ScreenToWorldPlanePoint(Camera.main, dragDepth, screenPosition);
